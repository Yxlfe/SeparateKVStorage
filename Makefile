...
SHARED_LIB1 = libspkvdb.$(PLATFORM_SHARED_EXT)
...
all: $(SHARED_LIBS) $(SHARED_PROGRAMS) $(STATIC_OUTDIR)/libspkvdb.a $(STATIC_OUTDIR)/libmemenv.a $(STATIC_PROGRAMS)
...
ifeq ($(PLATFORM), IOS)
$(DEVICE_OUTDIR)/libspkvdb.a: $(DEVICE_LIBOBJECTS)
	rm -f $@
	$(AR) -rs $@ $(DEVICE_LIBOBJECTS)

$(SIMULATOR_OUTDIR)/libspkvdb.a: $(SIMULATOR_LIBOBJECTS)
	rm -f $@
...
# a device.
$(STATIC_OUTDIR)/libspkvdb.a: $(STATIC_OUTDIR) $(DEVICE_OUTDIR)/libspkvdb.a $(SIMULATOR_OUTDIR)/libspkvdb.a
	lipo -create $(DEVICE_OUTDIR)/libspkvdb.a $(SIMULATOR_OUTDIR)/libspkvdb.a -output $@
...
$(STATIC_OUTDIR)/memenv_test:$(STATIC_OUTDIR)/helpers/memenv/memenv_test.o $(STATIC_OUTDIR)/libmemenv.a $(STATIC_OUTDIR)/libspkvdb.a $(TESTHARNESS)
	$(XCRUN) $(CXX) $(LDFLAGS) $(STATIC_OUTDIR)/helpers/memenv/memenv_test.o $(STATIC_OUTDIR)/libmemenv.a $(STATIC_OUTDIR)/libspkvdb.a $(TESTHARNESS) -o $@ $(LIBS)
