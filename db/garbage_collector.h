...
class GarbageCollector
{
    public:
        ...
        void BGCleanBeginGarbageCollect(bool* shutdown, uint64_t& read_size, uint64_t& rewrite_size);
        void BeginGarbageCollect(VersionEdit* edit, bool* save_edit, uint64_t& read_size, uint64_t& rewrite_size);
        ...
        struct rewriteKeyInfo{
            ...
            rewriteKeyInfo(): rewriteCount(0), 
                                rewriteSmallestKeySize(0), 
                                rewriteSmallestKey(""), 
                                rewritelargestKeySize(0), 
                                rewritelargestKey("") {}
        };
    private:
